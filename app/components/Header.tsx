...
const Header: FC<Props> = ({ open, setOpen,route, activeItem,setRoute}) => {
      ...
      <div
        className={`${
          active
            ...
            : "w-full border-b dark:border-[#ffffff] h-[80px] z-[80] dark:shadow"
        }`}
      >
          ...
          <div className="w-full h-[80px) flex items-center justify-between p-3">
            ...
            <div className="flex items-center">
              ...
              <div className="800px:hidden">
                <HiOutlineMenuAlt3
                  size={25}
                  className="cursor-pointer darkitext-white text-black"
                  onClick={() =>{
          ...
          >
            <div className="w-[70%] fixed z-[99999999] h-screen bg-white dark:bg-slate-900 dark:bg-opacity-90 top-0 right-0">
              ...
              <HiOutlineUserCircle
                ...
                className="cursor pointer al-s my Otext-black darkstext-white"
                onClick={() => setOpen(true)}
              />
              <br />
              <br />
              <p className="text-[16px] pr-2 pl-5 text-black dark:text-white">
